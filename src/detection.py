...
# Load YOLO models (paths to be updated)
breed_model = YOLO("/content/SIH_Cattle_App/models/breed_model.pt")
keypoint_model = YOLO("/content/SIH_Cattle_App/models/keypoint_model.pt")
