...
def extract_traits(keypoints):
    traits = {}
    traits["Body Length"] = euclidean(keypoints[2], keypoints[1])
    traits["Height"] = euclidean(keypoints[0], keypoints[4])
    traits["Chest Width"] = euclidean(keypoints[2], keypoints[6])
    traits["Rump Angle"] = angle(keypoints[3], keypoints[1], keypoints[7])
    return traits
